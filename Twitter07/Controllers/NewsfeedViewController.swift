...
class NewsfeedViewController: UIViewController, UITextFieldDelegate {
    ...
    private lazy var pastTableViewController: PastTableViewController = {
        ...
        //Seed Data
        tableViewController.tweets = self.seedData!.sortedPastTweets(time: seedData!.time)
    ...
    private lazy var futureTableViewController: FutureTableViewController = {
        ...
        //Seed Data
        tableViewController.tweets = self.seedData!.sortedFutureTweets(time: seedData!.time)
    ...
    private func add(asChildViewController viewController: UIViewController) {
        ...
        self.newsfeedView.addSubview(viewController.view)
        
        // Configure Child View
        viewController.view.frame = self.newsfeedView.bounds
